...
SECONDRY_QUEUE_NAME=${SECONDARY_QUEUE_URL##*/}
PRIMARY_DR_QUEUE_NAME=${PRIMARY_DR_QUEUE_ARN##*:}
...
DASHBOARD_BODY=$(cat dashboard.json | \
    ...
    sed "s/\${SecondaryQueueName}/${SECONDRY_QUEUE_NAME}/g" | \
    sed "s/\${SecondaryDrQueueName}/${SECONDARY_DR_QUEUE_NAME}/g" | \
    sed "s/\${PrimaryDrQueueName}/${PRIMARY_DR_QUEUE_NAME}/g" | \
